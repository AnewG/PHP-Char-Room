<?php
namespace Man\Core;
use Man\Core\Events\BaseEvent;  // 事件轮询库的通用 interface 文件

require_once WORKERMAN_ROOT_DIR . 'Core/Events/Select.php';  // select 轮询封装
require_once WORKERMAN_ROOT_DIR . 'Core/AbstractWorker.php'; // 抽象 worker
require_once WORKERMAN_ROOT_DIR . 'Core/Lib/Config.php';     // 配置类[解析ini配置文件]
